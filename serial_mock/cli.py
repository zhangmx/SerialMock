...
if __name__ == "__main__":
    ...
    g2 = subparsers.add_parser("bridge",
                               help="create a bridge between two ports, this is useful for generating a logfile")
    ...
    g2.add_argument("-L", '--logfile',
                    help='this will log all incomming and outgoing messages, this can be used with the build subcommand')
    g3 = subparsers.add_parser("build",
                               help="build a serialport emulator from a logfile generated from the bridge utility")
    g2.set_defaults(which="g3")
    g3.add_argument("bridge_file",
                    help="a logfile generated from the --bridge_to utility. this must be generated with the bridge logfile utility",
    ...
    if "COM1" in args and "COM2" in args:
        interface = BridgeSerial(args.COM1, args.COM2, logfile=args.logfile, delimiter=args.delimiter,
                                 endline=args.endline).MainLoop()
    elif "COM1" in args:
